...
#                res = (a-1) + 2 ** (a-1) //calculation determined from formulae
#                print ('\n current value of a is' ,a, 'current value of b is',b,'next value in sequence should be (a-1) + 2 ** (a-1):', res) //test statement
    ...
    def funct(x):
        ...
        if x == 1:
            ...
            for i in range (2,x+1):
                res = (a-1) + 2 ** (a-1)
                print ('\n current value of a is' ,a, 'current value of b is',b,'next value in sequence should be (a-1) + 2 ** (a-1):', res)
                print(',',res, end ="")
                a = b
                b = res
        print()
