...
#                res = 2 * (a-1) //variable result will equal to calculation (as interprted from formulae)
#                print ('\n current value of a is' ,a, 'current value of b is',b,'next value in sequence should be 2 * (a-1):', res) //print out the test statement (evidence of recurssion)
    ...
    def funct(x):
        ...
        if x == 1:
            ...
            for i in range (2,x+1):
                res = 2 * (a-1)
                print ('\n current value of a is' ,a, 'current value of b is',b,'next value in sequence should be 2 * (a-1):', res)
                print(',',res, end ="")
                a = b
                b = res
        print()
